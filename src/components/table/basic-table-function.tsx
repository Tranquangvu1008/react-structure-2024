...
type IProps = {
  ...
  children: (dataSource: any) => React.ReactNode
}

function BasicTableFunction({ dataSource, limit, tableHead, children, handleChange }: IProps) {
  return (
    <>
...
export default BasicTableFunction